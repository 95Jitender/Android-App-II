...
import com.example.myrecords_parents.StudentInfo.Fetchalldetails;
...
SharedPreferences spref;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		studentname=b.getString("studentname");
			...
			Toast.makeText(SubjectInfo.this,"Error :"+e, Toast.LENGTH_LONG).show();
		}
		name=(TextView)findViewById(R.id.textView1); name.setText(studentname);
		roll=(TextView)findViewById(R.id.textView2); roll.setText(rollno);
		att=(TextView)findViewById(R.id.textView3);
		message=(TextView)findViewById(R.id.textView4);
		btn=(Button)findViewById(R.id.button1);
		if(isNetworkAvailable()==true){
			new Fetchallcolumns().execute();
		...
		btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i= new Intent(SubjectInfo.this,MarksInfo.class);
     ...
     int flag=0; 
      @Override
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pb = new ProgressDialog(SubjectInfo.this);
		...
		protected void onPostExecute(Void result) {
			...
			if(flag==1){ Toast.makeText(SubjectInfo.this, "Connection Timeout.. Try Again Later.", Toast.LENGTH_LONG).show();
    	...
    	public void getData(){
    		...
    		try{
    			...
    			HttpPost httppost = new HttpPost("http://"+serverurl+"/myrecordsparents/fetchattendancecolumns.php?rollno="+rollno+"&semister="+semister
	...
	class Fetchattendance extends AsyncTask<Void, Void, Void>
	{
	ProgressDialog pb;
     int flag=0; 
      @Override
		...
		protected void onPostExecute(Void result) {
			...
			//lv.setAdapter(adapter);
				...
				for(int j=5;j<split.length;j++){
					...
					att.append(split2[0]+"   "+split2[1]+"/"+split2[2]+"/"+split2[3]+"   "+
							split2[4]+":"+split2[5]+" "+split2[6]+"  -  "+values.get(j)+"\n\n");
				}
    	...
    	public void getData(){
    		...
    		try{
    			...
    			HttpConnectionParams.setConnectionTimeout(params,5000);
    			HttpConnectionParams.setSoTimeout(params,5000);
    			HttpPost httppost = new HttpPost("http://"+serverurl+"/myrecordsparents/fetchattendance.php?rollno="+rollno+"&semister="+semister
    					+"&subject="+subject+"&teachername="+teachername.replaceAll(" ","_")+"&batch="+batch+"&classname="+classname);
    			HttpResponse response = httpClient.execute(httppost);
    			if(response !=null)
    			{
...
public boolean isNetworkAvailable() {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) 
	{
		 if(keyCode == KeyEvent.KEYCODE_BACK)
		    { Intent i = new Intent(SubjectInfo.this, StudentInfo.class );
		    i.putExtra("rollno",rollno);
		    i.putExtra("semister",semister);
			i.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
			startActivity(i);
